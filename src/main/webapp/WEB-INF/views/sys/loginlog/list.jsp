...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${sctx}/loginlog" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" href="${sctx}/loginlog/delete" class="delete"><span>批量删除</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		<thead>
			<tr>
				...
				<th width="150" align="center"  <tag:orderField name="createTime"/>>登录时间</th>
				<th width="120" >用户名</th>
				<th width="120" >姓名</th>
				<th width="120" align="center">登录IP</th>
				<th width="" >类型</th>
				<th width="80">操作</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${page.content}" var="item" varStatus="index">
				<tr target="sid" rel="${item.id}">
					...
					<td>
						<a title="删除" target="ajaxTodo" href="${sctx}/loginlog/delete/${item.id}" class="btnDel">删除</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
