...
<div class="pageContent">
	<form method="post" action="${ctx}//government" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="58">
			...
			<div class="unit">
				...
				<input name="search_LIKE_fieldName" id="MyObj.fieldName" type="text" postField="keyword" suggestFields="fileName" 
					suggestUrl="${ctx}//government/funcList" lookupGroup="MyObj"/>
