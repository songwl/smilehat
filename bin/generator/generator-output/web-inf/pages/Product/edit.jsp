...
<div class="pageContent">
	<form method="post" action="${ctx}//product/${action}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
