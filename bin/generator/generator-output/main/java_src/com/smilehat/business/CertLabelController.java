 ...
 */
@Controller
@RequestMapping(value =  Constants.SPT+CertLabelController.PATH)
public class CertLabelController extends BaseController {
	 
	@Autowired
	private CertLabelService certLabelService;
	public static final String PATH = "/certlabel";
